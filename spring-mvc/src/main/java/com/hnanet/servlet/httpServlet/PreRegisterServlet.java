...
/**
 * @usage http://localhost:8080/springmvc/customHttpServlet/preRegister
 *
 */
public class PreRegisterServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // 转发，客户端感知不到
        req.getRequestDispatcher("/customHttpServlet/register").forward(req,resp);

        // 重定向
        //resp.sendRedirect("/springmvc/customHttpServlet/register");
    }
}
